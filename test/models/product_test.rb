...
describe Product do
  ...
  describe "relationships" do
    describe "merchant" do
      before do
        @merchant = Merchant.create!(username: "Captain", email: "captain@email.com")
        @product = Product.new(name: "fries", price: 10.00)
      end
        it "can set the merchant using the Merchant" do
        ...
        it "can set the merchant using a merchant id" do
